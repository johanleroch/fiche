  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        onClick={onAddChild}
        className="nodrag absolute -bottom-4 left-1/2 -translate-x-1/2 flex items-center justify-center w-5 h-5 rounded-full bg-primary text-primary-foreground opacity-0 group-hover:opacity-100 hover:scale-110 transition-all duration-150 shadow-sm"
      >
